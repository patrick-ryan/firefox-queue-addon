...
// TODO: possibly should check if bookmarks exist
// TODO: verify that tabs have been saved (alert)
panel.port.on("bookmark-clicked", function() {
    ...
    save(bookmarks).on("end", function() {
        panel.port.emit("done-bookmarking", "UNSORTED");
    });
});

// TODO: need button to dequeue tab
function enqueueTab() {
